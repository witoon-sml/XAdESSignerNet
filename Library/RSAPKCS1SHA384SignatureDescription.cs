...
namespace Microsoft.Xades
{
    ...
    ///         for RSA-SHA384 signatures. It allows XML digital signatures to be produced using the
    ...
    ///     </para>
    ///     <para>
    ///         RSAPKCS1SHA384SignatureDescription is not generally intended for use on its own, instead it
    ...
    ///         instances of this signature description and use RSA-SHA384 signatures.
    ///     </para>
    ///     <para>
    ...
    ///                   <cryptoNameMapping>
    ///                     <cryptoClasses>
    ///                       <cryptoClass RSASHA384SignatureDescription="Security.Cryptography.RSAPKCS1SHA384SignatureDescription, Security.Cryptography, Version=1.1.0.0, Culture=neutral, PublicKeyToken=31bf3856ad364e35" />
    ///                     </cryptoClasses>
    ///                     <nameEntry name="http://www.w3.org/2001/04/xmldsig-more#rsa-sha384" class="RSASHA384SignatureDescription" />
    ///                   </cryptoNameMapping>
    ///                 </cryptographySettings>
    ///               </mscorlib>
    ///             </configuration>
    ...
    ///         RSAPKCS1SHA384SignatureDescription (in the example above Security.Cryptography.dll) needs to
    ///         be added to the GAC.
    ///    </para>
    ///    <para>
    ...
    ///     </para>
    ///     <para>
    ///         RSA-SHA384 signatures are first available on the .NET Framework 3.5 SP 1 and as such the
    ///         RSAPKCS1SHA384SignatureDescription requires .NET 3.5 SP 1 and Windows Server 2003 or greater
    ///         to work properly.
    ///     </para>
    ///     <para>
    ...
    public sealed class RSAPKCS1SHA384SignatureDescription : SignatureDescription
    {
        ...
        public RSAPKCS1SHA384SignatureDescription()
        {
            ...
            DigestAlgorithm = typeof(SHA384Managed).FullName;   // Note - SHA384CryptoServiceProvider is not registered with CryptoConfig
