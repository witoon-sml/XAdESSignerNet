    ...
    public class XadesSignedXml : System.Security.Cryptography.Xml.SignedXml
    {
        ...
        private SignatureDescription GetSignatureDescription()
        {
            ...
            if (description == null)
            {
                ...
                //Add SHA-384
                else if (this.SignedInfo.SignatureMethod == "http://www.w3.org/2001/04/xmldsig-more#rsa-sha384")
                {
                    CryptoConfig2.AddAlgorithm(typeof(Microsoft.Xades.RSAPKCS1SHA384SignatureDescription), "http://www.w3.org/2001/04/xmldsig-more#rsa-sha384");
                }
